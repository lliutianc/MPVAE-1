...
def eval_fairsoft_allmodels(args):
    ...
    fair_results_path = os.path.join(
        eval_results_path, f'fair_eval_gamma={args.dist_gamma:.2f}_seed{args.seed:04d}.pkl')
    perform_results_path = os.path.join(
        eval_results_path, f'perform_eval_gamma={args.dist_gamma:.2f}_seed{args.seed:04d}.pkl')
