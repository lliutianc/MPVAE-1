...
from label_distance_obs import hamming_similarity
...
def train_fair_through_regularize(args):
    hparams = f'hamming_distance-{args.dist_gamma}'
    ...
    fair_vae_checkpoint_path = os.path.join(
        args.model_dir, f'fair_vae_prior-{hparams}_{args.seed:04d}.pkl')
