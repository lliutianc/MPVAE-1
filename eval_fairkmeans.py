...
from faircluster_kmeans import parser
...
if __name__ == '__main__':
    ...
    for k in [8, 16, 32, 64]:
        ...
        label_cluster_path = os.path.join(
            model_dir,
            f'label_cluster-'
            f'labels_embed={args.labels_embed_method}' + '.npy')
...
# python eval_fairkmeans.py -dataset adult -latent_dim 8 -fairness_strate_embed none -labels_embed_method none -cuda 8
